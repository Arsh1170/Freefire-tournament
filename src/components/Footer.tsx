  ...
  return (
    <footer className="bg-luxury-black border-t border-white/5 pt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-20">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-3 mb-8">
              <div className="w-10 h-10 bg-red-600 flex items-center justify-center transform rotate-45 border border-white/20">
                <span className="-rotate-45 font-black text-xl text-black">V</span>
              </div>
              <span className="text-2xl font-black tracking-tighter uppercase italic">
                IGNIS <span className="text-red-500">ESPORTS</span>
              </span>
            </div>
            ...
            <div className="flex gap-4">
              {[1, 2, 3, 4].map(i => (
                <div key={i} className="w-10 h-10 bg-white/5 border border-white/10 flex items-center justify-center hover:bg-red-600 transition-all cursor-pointer group hover:-translate-y-1">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-5 text-[10px] text-white/40 font-black uppercase tracking-widest">
              <li><a href="#" className="hover:text-red-500 hover:pl-2 transition-all block">Tournaments</a></li>
              <li><a href="#" className="hover:text-red-500 hover:pl-2 transition-all block">Leaderboards</a></li>
              <li><a href="#" className="hover:text-red-500 hover:pl-2 transition-all block">Clan Wars</a></li>
              <li><a href="#" className="hover:text-red-500 hover:pl-2 transition-all block">Hall of Fame</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-5 text-[10px] text-white/40 font-black uppercase tracking-widest">
              <li><a href="mailto:ops@ignis.net" className="hover:text-red-500 transition-all flex items-center gap-3">ops@ignis.net</a></li>
              <li><span className="flex items-center gap-3">Sector-7 Deployment HQ</span></li>
              <li><a href="tel:+1800IGNIS" className="hover:text-red-500 transition-all flex items-center gap-3">+1 (800) IGNIS-99</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex border-b border-white/10 pb-2 focus-within:border-red-600 transition-colors">
              <input 
                type="email" 
      ...
      <div className="h-16 border-t border-white/5 flex items-center bg-black/80 relative z-20 overflow-hidden">
        <div className="px-10 bg-red-600 h-full flex items-center shrink-0">
        ...
        <div className="flex-1 flex items-center px-10 gap-12 whitespace-nowrap text-[10px] font-black uppercase tracking-[0.3em] text-white/40 animate-ticker">
          ...
          <span className="text-white/10">|</span>
          <span className="flex items-center gap-4">MATCH #47 STARTING IN <span className="text-red-500">00:14:59</span></span>
        </div>
