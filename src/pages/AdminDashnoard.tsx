  ...
  return (
    <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-12">
        <div>
          <h1 className="text-4xl font-black italic tracking-tighter uppercase">MISSION <span className="text-luxury-red">CONTROL</span></h1>
      ...
      {/* Broadcast Section */}
      <div className="mb-12 glass p-8 border-luxury-red/30 bg-luxury-red/5">
        <h2 className="text-xl font-black italic uppercase italic tracking-tighter mb-6 flex items-center gap-3">
          <Send className="text-luxury-red" /> PREMUM PROTOCOL: <span className="text-luxury-gold">ROOM BROADCAST</span>
        </h2>
        ...
        <AnimatePresence>
          {status && (
            <motion.p 
              ...
              exit={{ opacity: 0 }}
              className="mt-4 text-[10px] font-black uppercase tracking-widest text-luxury-red animate-pulse"
            >
              [ SYSTEM ] {status}
            </motion.p>
          )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          {[
            { label: 'Active Reports', value: '12', icon: AlertCircle, color: 'text-luxury-red' },
                ...
                <div key={i} className="flex items-center justify-between p-4 bg-white/5 hover:bg-white/10 transition-colors border-l-2 border-luxury-gold cursor-pointer">
                  ...
                  <div className="flex items-center gap-8">
                    <div className="text-right">
                      ...
                      <span className="text-[10px] font-black uppercase text-luxury-red animate-pulse">TRANSMITTING</span>
                    </div>
